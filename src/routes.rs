...
use crate::{handler::{auth::auth_handler, post::post_handler, review::review_handler, search::search_handler, users::users_handler}, middleware::auth, AppState};
...
pub fn create_router(app_state: AppState) -> Router {
    let api_route = Router::new()
        ...
        .nest(
            "/users", 
            users_handler()
                .layer(middleware::from_fn_with_state(app_state.clone(), auth)) //여기서 middleware.rs에서 만든 middleware를 적용하는거임.
